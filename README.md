...
│   ├── AgentUsageProviding.swift
│   └── AgentTokenTrackerUsageProvider.swift
...
**Q: 为什么没有所有智能体的 Token 热力图？**

A: 请确保已安装 Node.js 20 或更高版本。首次切换到热力图时，应用会一次性运行 TokenTracker 并读取本地记录；也可通过 `TOKENTRACKER_PATH` 指定已安装的 CLI。
